      ...
      toast.success(
        <div className="flex flex-col gap-2">
          ...
          <a 
            ...
            target="_blank"
            className="bg-brand-900 text-white text-xs text-center py-1.5 px-3 rounded mt-1 font-bold hover:bg-brand-800"
          >
            VER FACTURA Y PDF
          </a>
        </div>,
        ...
        <CardContent className="p-8 space-y-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="bg-brand-100 text-brand-900 w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">1</div>
            ...
            <Select value={selectedClient} onValueChange={setSelectedClient}>
              ...
              <SelectContent>
                {clients.filter(c => c.isVermut !== false).map(c => (
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <div className="bg-brand-100 text-brand-900 w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">2</div>
              <h2 className="text-xl font-semibold">Añadir Producto</h2>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* ROJO */}
              <div className="border rounded-xl p-6 flex flex-col items-center space-y-4 shadow-sm hover:border-brand-200 transition-colors">
                ...
                <div className="flex items-center gap-4 bg-slate-100 p-2 rounded-lg">
                  ...
                  <input 
                    ...
                    className="text-2xl font-bold w-16 text-center bg-transparent border-b-2 border-transparent focus:border-brand-300 focus:outline-none hide-arrows" 
                  />
          ...
          <div className="space-y-4 pt-2">
             <Button 
                ...
                className="w-full h-16 text-xl bg-brand-900 hover:bg-brand-800 text-white font-bold rounded-xl shadow-lg"
              >
